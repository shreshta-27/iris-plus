      ...
      <div className="w-full max-w-md">
        <div className="bg-brutal-card border-2 border-iris-600 shadow-brutal p-8 rounded-none">
          <div className="mb-8">
            ...
            <p className="text-gray-400 mt-1">Join IRIS to start learning</p>
          </div>
          ...
          <div className="mt-6 text-center text-sm text-gray-400">
            ...
            <Link href="/login" className="text-iris-400 hover:text-iris-300 font-bold underline decoration-2 underline-offset-4">
              Sign in
            </Link>
          </div>
        </div>
