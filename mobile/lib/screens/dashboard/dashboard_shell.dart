      ...
      bottomNavigationBar: Container(
        ...
        child: BottomNavigationBar(
          ...
          items: [
            ...
            _buildNavItem(Icons.quiz_outlined, 'Quiz Forge', IrisColors.sunny, currentIndex == 1),
            _buildNavItem(Icons.work_outline, 'Career Sim', IrisColors.peach, currentIndex == 2),
            _buildNavItem(Icons.bar_chart_outlined, 'Analytics', IrisColors.sky, currentIndex == 3),
